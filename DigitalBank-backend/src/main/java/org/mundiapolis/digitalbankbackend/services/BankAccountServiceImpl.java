...
import org.mundiapolis.digitalbankbackend.mappers.BankAccountMapperImpl;
...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    @Override
    public List<AccountOperationDTO> accoutHistory(String accountId){
    ...
    public AccountHistoryDTO getAccountHistory(String accountId, int page, int size) throws BankAccountNotFoundException {
        ...
        Page<AccountOperation> accoutOperations = accountOperationRepository.findByBankAccountIdOrderByOperationDateDesc(accountId, PageRequest.of(page, size));
        AccountHistoryDTO accountHistoryDTO = new AccountHistoryDTO();
        List<AccountOperationDTO> accountOperationDTOS = accoutOperations.getContent().stream().map(op -> dtoMapper.fromAccountOperation(op)).collect(Collectors.toList());
